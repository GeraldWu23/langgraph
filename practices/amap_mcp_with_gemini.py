...
class Client:
    def __init__(self):
        ...
        # ---- Replace AsyncOpenAI with LangChain chat model ----
        # You can pass in the API key via environment or directly:
        load_dotenv()

        GEMINI_MODEL = "gemini-2.0-flash"
        self.chat_model = init_chat_model(GEMINI_MODEL, model_provider='google_genai')
    ...
    async def chat_loop(self):
        ...
        while True:
            ...
            while result != response:
                response = await self.chat(result, "user")  # todo: system
...
if __name__ == '__main__':
    # 我要去广州花城汇出差，请你查询附近5km的酒店，为我安排行程
    asyncio.run(main())
